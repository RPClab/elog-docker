...
EXPOSE 8080
RUN apk --no-cache add git musl-dev krb5-dev openssl-dev mariadb-common mariadb-client openssl alpine-conf krb5 gcc make imagemagick-libs imagemagick ghostscript ghostscript-gtk ghostscript-dev  ghostscript-fonts && \
